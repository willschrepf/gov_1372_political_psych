...
p <- player_data_long %>%
  ...
  geom_tile() +
   scale_fill_gradient(low = "lightgreen",
                      high = "darkgreen",
                      guide = "colorbar") +
  guides(colour=FALSE) + labs(title = "Success of Strategies Against One Another", subtitle = "In Repeated Axelrod Simulations", y = "Player", x = "Opponent", fill = "Score of PLAYER \n(on the y-axis)")
